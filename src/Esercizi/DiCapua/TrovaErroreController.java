...
public class TrovaErroreController implements Initializable {
    ...
    private void loadDomanda() {
        ...
        startTimer();
        // switch che serve a mostrare a schermo la giusta difficoltà e con il giusto
        // colore
    ...
    // -------------------------------------------------------------------------------------------------------------------------------------------------
    // metodo richiamato quando l'utente clicca sul tasto "Avanti" presente nel file
    // .fxml
    ...
    private void avanti() {
        ...
        if (riga.equals(RigaErrore)) {
            ...
            if (IndiceEsercizioCorrente == 4 && difficolta.equals("Difficile")) {
                // Aggiorna il punteggio finale anche se l'utente ha completato l'ultimo
                // esercizio
            ...
            if (IndiceEsercizioCorrente == 4) {
                // Aggiorna la difficoltà da cui dipende la scelta dell'esercizio solo dopo aver
                // completato tutti e 4 gli esercizi
            ...
            alert.setHeaderText("la Riga inserito non è corretta.");
